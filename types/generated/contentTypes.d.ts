...
export interface ApiContactDataContactData extends Struct.SingleTypeSchema {
  collectionName: 'contact_datas';
  info: {
    displayName: 'ContactData';
    pluralName: 'contact-datas';
    singularName: 'contact-data';
  };
  options: {
...
export interface ApiLandingPageLandingPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reportSection: Schema.Attribute.Component<'sections.reports', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workflowSection: Schema.Attribute.Component<'sections.workflow', false>;
  };
}
...
export interface ApiPrivacyPolicyPrivacyPolicy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entry_list: Schema.Attribute.Component<
      'components.privacy-policy-entry',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::contact-data.contact-data': ApiContactDataContactData;
